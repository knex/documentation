export default [
  ...
  },
  {
    ...
    description:
      "Creates a new view or replace it on the database, with a callback function to modify the view's structure, using the schema-building commands.",
    children: [
      {
        type: "runnable",
        content: `
  ...
  },
  {
    ...
    description:
      "Adds an integer column. In PostgreSQL you cant modify the length, you must use other like `bigInteger`, `tinyint`",
    children: [],
  },
  {
    type: "method",
    method: "tinyint",
    example: "table.tinyint(name)",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        type: "info",
        content:
          "Note: If you want to chain primary() while creating new column you can use <a href='#Schema-column-primary'>primary</a>",
      },
    ],
  },
  {
    ...
    example:
      "table.unique(columns, options={[indexName: string], [deferrable:'not deferrable'|'immediate'|'deferred'], [storageEngineIndexType:'btree'|'hash']})",
    description:
    ...
    children: [
      ...
      },
      {
        type: "info",
        content:
          "Note: If you want to chain unique() while creating new column you can use <a href='#Schema-column-unique'>unique</a>",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        type: "info",
        content:
          "Note: If you want to create primary constraint on existing column use <a href='#Schema-table-primary'>primary</a>",
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        type: "info",
        content:
          "Note: If you want to create unique constraint on existing column use <a href='#Schema-table-unique'>unique</a>",
      },
    ],
  },
  {
    ...
    description:
      'Sets the "column" that the current column references as a foreign key. "column" can either be ".<column>" syntax, or just the column name followed up with a call to inTable to specify the table.</column>\n\n<table></table>',
    children: [],
  },
  {
    type: "method",
