    ...
    children: [
      {
        ...
        content: `
          ...
          knex.schema.alterTable('job', function(t) {
            t.unique(['account_id', 'program_id'], {indexName: 'users_composite_index', constraint:true})
          })
        `
      },
      {
