export default [
  ...
  {
    type: "text",
    content: "You can access promise that gets resolved after transaction is committed, or rejected if it gets rolled back, when using either way of creating transaction, from field `executionPromise`:"
  },
  {
    type: "code",
    language: "js",
